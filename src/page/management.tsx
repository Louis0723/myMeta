...
export class ManagementComponent extends React.Component {
	...
	render() {
		let loginState = this.topState.loginState;
		let loginType = loginState.loginType;
		return (
	...
	saveAccountToLocalStorage = (event) => {
		...
		let loginState = this.topState.loginState;
		let accountName = loginState.account
		let accountPwd = loginState.accountPwd;
	...
	onChangeAccountName = (e) => {
		this.topState.loginState.account = e.target.value;
	};

	onChangeAccountPwd = (e) => {
		this.topState.loginState.accountPwd = e.target.value;
	};
